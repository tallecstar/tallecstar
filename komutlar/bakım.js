...
exports.run = (client, message, args) => {
  ...
  if(message.author.id != "683752128644251660") return message.channel.send("```Bu komutu sadece sahibim kullana bilir görünüşe göre sen sahibim değilsin yada senmisin?!```")
